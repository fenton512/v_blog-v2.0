from .base import Base, target_metadata
...
users_in_group = Table(
    ...
    Column("groupe_id", Integer, ForeignKey("groups.id", ondelete="CASCADE"), primary_key=True, index=True)
)
...
posts_in_group = Table(
    ...
    target_metadata, 
    Column("post_id", Integer, ForeignKey("posts.id", ondelete="CASCADE"), primary_key=True, index=True),
    Column("group_id", Integer,ForeignKey("groups.id", ondelete="CASCADE"), primary_key=True, index=True),
)